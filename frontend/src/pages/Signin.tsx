      ...
      <div className="w-full max-w-[440px] bg-surface border border-border shadow-sm rounded-3xl p-8 sm:p-10">
        ...
        <div className="space-y-6">
          ...
          <p className="text-sm text-foreground/60 text-center font-medium pt-4">
            ...
            <Link to="/signup" className="text-primary hover:text-primary/80 font-bold transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded-sm">
              Create one
            </Link>
          </p>
        </div>
